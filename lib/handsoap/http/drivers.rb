...
require 'handsoap/http/drivers/curb'
require 'handsoap/http/drivers/httpclient'
require 'handsoap/http/drivers/net_http'

module Handsoap
  module Http
    @@drivers = {
      :net_http => Drivers::NetHttp,
      :curb => Drivers::Curb,
      :httpclient => Drivers::Httpclient,
    }
